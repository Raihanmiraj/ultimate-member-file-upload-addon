...
//   include  plugin_dir_path(dirname(dirname(__DIR__))).'um-file-upload/process/index.php';
...
function um_submit_account_errors_hook($args)
{
    ...
    switch ($tab) {
            case 'fileupload': {
                   if((isset($_POST['folder_name']) && $_POST['folder_name']!='') && (isset($_POST['folderid']) && $_POST['folderid']!='')){
                    $folderid = $_POST['folderid'];
                    $folder_name_get = $_POST['folder_name'];
                ...
                }else if(isset($_FILES['um_file_upload'])){
